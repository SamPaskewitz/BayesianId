...
namespace model_normal_intercept_est_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 16> locations_array__ =
  {" (found before start of program)",
  " (in 'normal_intercept_est', line 9, column 2 to column 14)",
  " (in 'normal_intercept_est', line 10, column 2 to column 22)",
  " (in 'normal_intercept_est', line 13, column 2 to column 10)",
  " (in 'normal_intercept_est', line 14, column 2 to column 28)",
  " (in 'normal_intercept_est', line 19, column 4 to column 41)",
  " (in 'normal_intercept_est', line 18, column 19 to line 20, column 3)",
  " (in 'normal_intercept_est', line 18, column 2 to line 20, column 3)",
  " (in 'normal_intercept_est', line 22, column 2 to column 49)",
  " (in 'normal_intercept_est', line 23, column 2 to column 26)",
  " (in 'normal_intercept_est', line 2, column 2 to column 17)",
  " (in 'normal_intercept_est', line 3, column 9 to column 10)",
  " (in 'normal_intercept_est', line 3, column 2 to column 14)",
  " (in 'normal_intercept_est', line 4, column 2 to column 13)",
  " (in 'normal_intercept_est', line 5, column 2 to column 17)",
  " (in 'normal_intercept_est', line 6, column 2 to column 28)"};
#include <stan_meta_header.hpp>
class model_normal_intercept_est final : public model_base_crtp<model_normal_intercept_est> {
private:
  int N;
...
public:
  ~model_normal_intercept_est() {}
  model_normal_intercept_est(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_normal_intercept_est_namespace::model_normal_intercept_est";
    // suppress unused var warning
    (void) function__;
  ...
  inline std::string model_name() const final {
    return "model_normal_intercept_est";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_normal_intercept_est_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_normal_intercept_est_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_normal_intercept_est_namespace::model_normal_intercept_est;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_normal_intercept_est_namespace::profiles__;
}
#endif
#endif
