...
namespace model_normal_linear_sim_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 16> locations_array__ =
  {" (found before start of program)",
  " (in 'normal_linear_sim', line 7, column 2 to column 10)",
  " (in 'normal_linear_sim', line 8, column 2 to column 14)",
  ...
  " (in 'normal_linear_sim', line 8, column 9 to column 10)",
...
public:
  ~model_normal_linear_sim() {}
  model_normal_linear_sim(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_normal_linear_sim_namespace::model_normal_linear_sim";
    // suppress unused var warning
    (void) function__;
  ...
  inline std::string model_name() const final {
    return "model_normal_linear_sim";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_normal_linear_sim_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_normal_linear_sim_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_normal_linear_sim_namespace::model_normal_linear_sim;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_normal_linear_sim_namespace::profiles__;
}
#endif
#endif
