...
static constexpr std::array<const char*, 16> locations_array__ =
  ...
  " (in 'normal_linear_sim', line 16, column 2 to column 30)",
  " (in 'normal_linear_sim', line 13, column 2 to column 22)",
  " (in 'normal_linear_sim', line 17, column 2 to column 34)",
  ...
  " (in 'normal_linear_sim', line 16, column 8 to column 15)"};
