...
namespace model_bernoulli_logistic_intercept_est_namespace {
...
static constexpr std::array<const char*, 14> locations_array__ =
  ...
  " (in 'bernoulli_logistic_intercept_est', line 21, column 2 to column 49)",
...
private:
  ...
  double prior_scale;
public:
  ~model_bernoulli_logistic_intercept_est() {}
  model_bernoulli_logistic_intercept_est(stan::io::var_context& context__,
    ...
    static constexpr const char* function__ =
      "model_bernoulli_logistic_intercept_est_namespace::model_bernoulli_logistic_intercept_est";
    // suppress unused var warning
    (void) function__;
  ...
  inline std::string model_name() const final {
    return "model_bernoulli_logistic_intercept_est";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_bernoulli_logistic_intercept_est_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      b0 = (stan::math::logit(Ymean) + (1.81 * delta0));
      {
        ...
        if (stan::math::logical_negation(prior_only)) {
          ...
          lp_accum__.add(stan::math::bernoulli_logit_lpmf<false>(Y, b0));
        }
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_bernoulli_logistic_intercept_est_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"delta0"};
    if (emit_transformed_parameters__) {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"delta0\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"b0\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"}]");
  }
...
using stan_model = model_bernoulli_logistic_intercept_est_namespace::model_bernoulli_logistic_intercept_est;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_bernoulli_logistic_intercept_est_namespace::profiles__;
}
#endif
#endif
